...
client.on('ready', () => {
  ...
  let state_list = ['[제재] 경고0명, 제재0명','[점검] 서버점검내용 없음','[서버상태] 1서버ㅣ정상작동','[서버상태] 2서버ㅣ정상작동','[서버상태] 3서버ㅣ서버중지','[안내] 게임도중에 비신사적','[안내] 행위를 하시는 유저를','[안내] 발견시 신고해주시면','[안내] 제재해 드리겠습니다','[서버상태] 1서버ㅣ정상작동','[서버상태] 2서버ㅣ정상작동','[서버상태] 3서버ㅣ서버중지']
