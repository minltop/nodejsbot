...
client.on('ready', () => {
  ...
  let state_list = ['----------- 서버 상태 -----------','신스카트라 1서버ㅣ정상작동','신스카트라 1서버ㅣ정상작동','신스카트라 2서버ㅣ정상작동','신스카트라 2서버ㅣ정상작동','신스카트라 3서버ㅣ서버중지','신스카트라 3서버ㅣ서버중지','[안내] 게임도중에 비신사적','[안내] 행위를 하시는 유저를','[안내] 발견시 신고해주시면','[안내] 제재 해드리겠습니다']
